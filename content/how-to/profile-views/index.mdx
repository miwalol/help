---
title: Profile Views
description: Learn what profile views are on Miwa.lol, where to find your view count, and how to increase it.
---
...
## Hiding your profile views <Badge text="Premium feature" />

If you want to hide your profile views from other users, you can do so in [Dashboard > Customize](https://miwa.lol/dashboard/customize), under the *Privacy* tab. This will hide your profile views from other users, but you will still be able to see your own profile views.
