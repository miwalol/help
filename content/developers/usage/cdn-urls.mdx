...
| `badges`           | Custom badge images. The API returns the badge's image ID, which you use as the filename.                                                                            |
| `profile-favicons` | Custom favicons uploaded for the browser tab                                                                                                                         |
