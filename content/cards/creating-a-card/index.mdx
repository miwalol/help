...
import { SiDiscord, SiX, SiTelegram, SiYoutube, SiTiktok, SiInstagram, SiAnilist, SiSpotify, SiApplemusic, SiOsu, SiSteam, SiRoblox, SiModrinth, SiGithub, SiJellyfin } from '@icons-pack/react-simple-icons';
