...
## Hiding and reordering your badges

**Your badges are managed on the [Badges](https://miwa.lol/dashboard/badges) page of your dashboard,** not in the Customize section.

- **Reorder them** by dragging a badge to the position you want. The order you set here is the order they appear in on your profile.
- **Hide a single badge** with the switch next to it.
- **Hide all of them at once** with the *Hide badges* switch at the top of the page. This also hides them on the [leaderboard](/getting-started/leaderboard/).

<Aside type="info">
  Only the badges you've actually earned show up on this page, so the list differs from one account to another.
</Aside>
...
**This badge is given to users who have reported multiple bugs to the Miwa.lol team. We require at least three, but that number may vary depending on the type and severity of the bugs reported.**
