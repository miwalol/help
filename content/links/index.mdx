...
import { Trash2, ListChecks, Link, Link2 } from 'lucide-react';
...
<CardGrid>
  ...
  />
  <LinkCard
    title="Adding a Custom Link" href="/links/adding-a-custom-link/" icon={Link2}
    description="You can add any link you want, such as a website or a specific page."
  />
  <LinkCard
    title="Supported Platforms" href="/links/supported-platforms/" icon={ListChecks}
