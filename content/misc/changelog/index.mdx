---
title: Changelog
description: A history of the latest features, improvements, and fixes released on Miwa.lol.
---

**This page may not be up-to-date, we recommend checking our social media:** https://links.miwa.lol.

## September 3, 2026

**🎨 Customization**
- **Pick an opening animation for your profile:** fade, pop, slide, zoom or blur (played when the visitor actually opens the page)
- **The profile card now pulses in time with your audio's beat**
- **Discord card:** richer presence with timestamps, party size (like *14 of 25*)
- **Give your profile card a border:** color, width, opacity and style (static, dashed, shimmer or pulse)

**🚀 Onboarding**
- **Import your profile from Linktree or guns.lol:** when creating your account, pick where you're coming from, and the preview tells you what you can import. We plan to add support to more platforms, so you can more easily migrate to Miwa.lol!

**🧩 Misc**
- Dashboard sidebar is collapsible, leaving more space for the content
- **Sessions:** log out several at once, see where each one is and when it was last active
- Bug fixes and improvements

## July 10, 2026

**🗂 Cards**
- **New cards:** Instagram (with recent posts), Last.fm, AniList, MyAnimeList, Jellyfin, Xbox, Modrinth, Location, and a simple Text card
- **Verification badges for Roblox, Discord servers, TikTok** and more are now shown next to the username.
- **Cards can be placed below your profile** and are editable anytime. Long text also scrolls instead of getting cut off.

**🎵 Audio**
- **Added artist & album info to your tracks.** (for existing audios, just edit their info or re-upload the audio!)
- See a queue of what's coming up next

**🔗 Links**
Links can now be hidden without deleting them, so you can tuck them away whenever you like.

**🎨 Personalization**
Custom cursors can now be animated using `.ani` files, giving your profile a little extra life.

**🧩 Templates**
You can now like your favorite templates, sort the gallery by most liked, and revisit them all in a new "Liked" tab.

**✨ Misc**
Lots of small fixes across the website to keep everything running smoothly :)

## June 1, 2026

- Analytics now include a graph of your views over the selected period.
- Avatar can now be easily cropped before uploading.
- **Added filters in templates:** Oldest, Newest and Trending filters.
- We've drastically improved accessibility.
- Numerous bugs were fixed.
- See all donors at https://miwa.lol/donors.
- **New links types:** Xbox, PlayStation, Signal, VK, Venmo, Bandcamp, Bitbucket, Codeberg, Letterboxd, Nintendo Switch FC, Riot ID
- **New cards:** Roblox, Genshin Impact, Honkai: Star rail, Time

## March 18, 2026

Customisation:
- **You can now add pronouns to your profile**. They'll appear beneath your username.
- **Bios now support Markdown formatting:** add bold, italics, underlines, and more.
- Your join date can now be displayed in multiple formats.
- Profile views are now also recorded when visiting a profile through a custom domain.
- **You can now upload a custom favicon for your profile tab,** in addition to the existing Miwa.lol logo and current avatar options.
- You can now change the roundness of your profile card.

Cards;
- **New card:** Weather
- **Minecraft card:** choose which cape services are displayed on the card (LabyMod, OptiFine, Minecraft, etc.)

Miscellaneous:
- **Template metadata (name, tags) can now be edited, and templates can be set as unlisted,** meaning they won't appear in public listings but are still accessible via direct link.
- Fixed a text rendering issue on Open Graph images.

## February 28, 2026

- **TikTok has been added as an available card.**
- **Accessibility has been greatly improved.** If you use screen readers or similar tools and encounter any issues, please let us know.
- Numerous small bugs have been fixed.
- **Beta features are now live.** Currently, no beta features are available, and access is limited to Premium users.
