...
On Miwa.lol, we have a leaderboard (https://miwa.lol/leaderboard) that ranks users based on their views and likes. By default, the leaderboard is sorted by likes (most likes first), but you can also sort it by views.

## Finding your position in the leaderboard
...
## I don't want to be in the leaderboard

If you don't want to be in the leaderboard, you can hide your views and likes in **Customize > Privacy**. This will hide your views and likes from other users, but you will still be able to see your own views and likes.
