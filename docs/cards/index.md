...
To follow this guide, go to your [dashboard](https://miwa.lol/dashboard) and click on the "**[Cards](https://miwa.lol/dashboard/cards)**" page in the left sidebar.

## Adding a Card

To add a card to your page, click the "**Create a card**" button on the right side of the page. From there, you can select the type of card you want to add:
