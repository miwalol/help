...
<Aside type="note">This is a Premium feature.</Aside>
...
A dialog will appear, prompting you to enter your custom domain. Type in your domain name (e.g., "example.com"), add the CNAME record to your DNS settings, and click "Verify".
