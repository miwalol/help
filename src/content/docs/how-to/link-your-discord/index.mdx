...
**Linking your Discord account to your Miwa account allows you to use the [Discord presence](/cards/examples/#discord-presence) card, which shows your current activity on Discord.**
