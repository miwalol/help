...
import { CodeBlock, Aside } from '@astrojs/starlight/components';
...
<Aside type="note">
  All URLs for assets are served via our CDN. You can find more information about our CDN URL structure in the [CDN URLs](/developers/cdn-urls/) documentation.
</Aside>